    ...
    <nav class="mt-6 space-y-1 overflow-y-auto flex-1 px-2 pb-6">
        ...
        @endif
            ...
            @if(auth()->user()->hasRole('admin'))
                ...
                <div class="px-4 pt-4 pb-1 text-xs font-bold uppercase tracking-widest text-slate-500 sidebar-text">
                    Brahma Accounts
                </div>

                <a href="{{ route('admin.brahma.deposits') }}"
                   class="flex items-center gap-3 py-2 px-4 rounded-lg hover:bg-slate-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wallet-cards"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>
                    <span class="sidebar-text">Brahma Deposits</span>
                </a>

                <a href="{{ route('admin.brahma.plays') }}"
                   class="flex items-center gap-3 py-2 px-4 rounded-lg hover:bg-slate-800">
                ...
                <a href="{{ route('admin.player-rank-settings') }}"
                   class="flex items-center gap-3 py-2 px-4 rounded-lg hover:bg-slate-800">
                    ...
                    <span class="sidebar-text">Player Rank Settings</span>
                </a>
                <div class="sidebar-text mt-4 px-4 text-[10px] font-black uppercase tracking-[0.25em] text-slate-500">CMS</div>
                <a href="{{ route('admin.cms.general-settings') }}"
                   class="flex items-center gap-3 rounded-lg py-2 pl-7 pr-4 hover:bg-slate-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.09a2 2 0 0 1-1-1.74v-.51a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2Z"/><circle cx="12" cy="12" r="3"/></svg>
            ...
            @if(auth()->user()->hasRole('agent'))
                ...
                <a href="{{ route('agent.brahma.deposits') }}"
                   class="flex items-center gap-3 py-2 px-4 rounded-lg hover:bg-slate-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wallet-cards"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>
                    <span class="sidebar-text">Brahma Deposits</span>
                </a>

                <a href="{{ route('agent.brahma.plays') }}"
                   class="flex items-center gap-3 py-2 px-4 rounded-lg hover:bg-slate-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-gamepad-2"><line x1="6" x2="10" y1="11" y2="11"/><line x1="8" x2="8" y1="9" y2="13"/><line x1="15" x2="15.01" y1="12" y2="12"/><line x1="18" x2="18.01" y1="10" y2="10"/><path d="M17.32 5H6.68a4 4 0 0 0-3.978 3.59C2.604 9.416 2 14.456 2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.414-1.414A2 2 0 0 1 9.828 16h4.344a2 2 0 0 1 1.414.586L17 18c.5.5 1 1 2 1a3 3 0 0 0 3-3c0-1.545-.604-6.584-.685-7.258A4 4 0 0 0 17.32 5z"/></svg>
                    <span class="sidebar-text">Brahma Plays</span>
                </a>
