<div>
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        @if(auth()->user()->hasRole('admin'))
            <a href="{{ url('/admin/wallets/agent-'.$wallet->wallet_agent_id.'/wallet-type-'.$wallet->wallet_type_id) }}"
               class="px-4 py-2 bg-slate-800 rounded-xl">
                ← Back
            </a>
        @elseif(auth()->user()->hasRole('agent'))
            <a href="{{ url('/agent/wallets/agent-'.$wallet->wallet_agent_id.'/wallet-type-'.$wallet->wallet_type_id) }}"
               class="px-4 py-2 bg-slate-800 rounded-xl">
                ← Back
            </a>
        @endif
